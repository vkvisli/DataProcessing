...
This module reads time-series data for dishwashers associated with the CoSSMic project
...
single_run_output = "./data/edited/dw_runs/"
...
# Dishwashers and their various information are stored in a list of Appliance objects
appliance_list = [Appliance("DE_KN_residential1_dishwasher", "Dishwasher 1"),
                  Appliance("DE_KN_residential2_dishwasher", "Dishwasher 2"),
                  Appliance("DE_KN_residential3_dishwasher", "Dishwasher 3"),
                  Appliance("DE_KN_residential4_dishwasher", "Dishwasher 4"),
                  Appliance("DE_KN_residential5_dishwasher", "Dishwasher 5")]
...
def split_time_series():
    ...
    for a in appliance_list:
        a.split_power_data(max_pause_allowed=10, min_duration=10, max_consumption=3.5)
...
# Splitting the time series into individual runs for each appliance
